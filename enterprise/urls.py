...
urlpatterns = patterns('',
    ...
    url(r'^projects/(?P<project_id>\d+)/review/$', views.project_submission, name='enterprise.project.review'),
    url(r'^projects/(?P<project_id>\d+)/evaluation/$', views.project_submission, name='enterprise.project.evaluation'),
    url(r'^projects/(?P<project_id>\d+)/monitor/$', views.project_submission, name='enterprise.project.monitor'),
    url(r'^projects/(?P<project_id>\d+)/selection/$', views.project_submission, name='enterprise.project.selection'),
