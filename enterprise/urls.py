...
urlpatterns = patterns('',
    ...
    url(r'^project/(?P<project_id>\d+)/(?P<element_id>\d+)/pdf/element$', views.element_evaluation_pdf, name='enterprise.project.pdf.element'),
    ...
    url(r'^project/(?P<project_id>\d+)/stage', views.project_stage, name='enterprise.project.stage'),
    url(r'^project/(?P<project_id>\d+)/(?P<element_id>\d+)/print/element/$', views.element_evaluation_print, name='enterprise.project.print.element'),
    ...
    url(r'^projects/(?P<project_id>\d+)/(?P<stage_id>\d+)/batch/create/$', views.create_batch, name='enterprise.stage.batch.create'),
    url(r'^projects/(?P<project_id>\d+)/(?P<batch_id>\d+)/batch/detail', views.batch_detail, name='enterprise.stage.batch.detail'),
    url(r'^projects/(?P<project_id>\d+)/(?P<stage_id>\d+)/batch', views.stage_batch, name='enterprise.project.batch'),
    ...
    url(r'^projects/(?P<project_id>\d+)/stages/add/$', views.create_stage, name='enterprise.project.stages.add'),
